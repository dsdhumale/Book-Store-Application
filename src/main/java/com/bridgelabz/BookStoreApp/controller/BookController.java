...
public class BookController {
     ...
     */
    @PostMapping("/insert")
    public ResponseEntity<ResponseDTO> insertBook(@RequestHeader(name = "Authorization") String token,
    ...
    public ResponseEntity<ResponseDTO> updateBookById(@RequestHeader(name = "Authorization") String token,
    ...
    public ResponseEntity<ResponseDTO> deleteBookById(@RequestHeader(name = "Authorization") String token,
    ...
    public ResponseEntity<ResponseDTO> updateQuantity(@RequestHeader(name = "Authorization") String token,
        ...
        ResponseDTO responseDTO = new ResponseDTO("Book quantity updated",
                bookService.updateQuantity(token, id, quantity));
        return new ResponseEntity<>(responseDTO, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseDTO> updatePrice(@RequestHeader(name = "Authorization") String token,
            @PathVariable long id, @RequestParam int price) {
