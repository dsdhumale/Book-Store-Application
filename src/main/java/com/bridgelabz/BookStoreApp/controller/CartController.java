...
public class CartController {
     ...
     */
    @PostMapping("/add")
    public ResponseEntity<ResponseDTO> addToBook(@RequestBody CartDTO cartDTO, @RequestHeader(name = "Authorization") String token) {
    ...
    public ResponseEntity<ResponseDTO> removeFromCart(@RequestHeader(name = "Authorization") String token, @PathVariable int id){
    ...
    public ResponseEntity<ResponseDTO> updateQuantity(@RequestHeader(name = "Authorization") String token,@RequestBody CartDTO cartDTO,@PathVariable long id){
        ResponseDTO responseDTO = new ResponseDTO("Cart Successfully Updated",cartService.updateQuantity(token,cartDTO,id));
